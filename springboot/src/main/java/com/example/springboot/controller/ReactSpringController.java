...
//    public ResponseEntity<String> addComment(@RequestBody MelodyMap_comment newComment) {
//        if (newComment.getCommentTitle() == null || newComment.getCommentTitle().isEmpty()) {
//            return ResponseEntity.badRequest().body("Comment title is required");
//        }
...
//    }
//
//    @GetMapping("/comments/{commentTitle}")
//    public ResponseEntity<?> getComment(@PathVariable String commentTitle) {
...
//    }
//
//    @DeleteMapping("/comments/{commentTitle}")
//    public ResponseEntity<String> deleteComment(@PathVariable String commentTitle) {
